...
> Eure Nutzer sollen sich durch eure Lernumgebung an faktisches Wissen erinnern.
...
| 2 | Abgabe | Die Person hat **keine** Webseite auf GiHubPages veröffentlicht. Die Lehrziele sind nicht umgesetzt. | Die Person die Webseite auf GitHubPages veröffentlicht. Die Webseite ist **nicht** vollständig. Die Webseite ist selbst entwickelt, und versucht die Lehrziele des Projektes umzusetzen. Die Person hat alle Kurse die unter **Kurse** gelistet sind, absolviert. | Die Person hat die Webseite auf GitHubPages veröffentlicht. Die Webseite ist vollständig, selbst entwickelt, und setzt die Lehrziele des Projektes um. Die Person hat alle Kurse die unter **Kurse** gelistet sind, absolviert. | 
...
| 5 | Design | Die Webseite verwendet **kein** konsistentes Design. Es werden **keine** [moderne Webschriftarten](https://fonts.google.com/) verwendet. Die Webseite verwendet **keine** hochauflösenden Grafiken (z.b. [FreePik](http://de.freepik.com/), [FlatIcon](http://www.flaticon.com/)) | Die Webseite verwendet ein konsistentes Design. Es werden [moderne Webschriftarten](https://fonts.google.com/) verwendet.  Die Webseite verwendet **keine** hochauflösenden Grafiken (z.b. [FreePik](http://de.freepik.com/), [FlatIcon](http://www.flaticon.com/)) | Die Webseite verwendet ein konsistentes Design. Es werden [moderne Webschriftarten](https://fonts.google.com/) verwendet. Die Webseite verwendet hochauflösende Grafiken (z.b. [FreePik](http://de.freepik.com/), [FlatIcon](http://www.flaticon.com/)).  Das HTML setzt die gängigen [Styles](http://www.w3schools.com/html/html5_syntax.asp) um. | 
